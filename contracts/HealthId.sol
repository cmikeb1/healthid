...
contract HealthId {
    ...
    modifier verifyAccountDoesNotExist(){require(accounts[msg.sender].owner == address(0));
        _;}
    ...
    function updateAccount(string memory _name, BloodType _bloodType, bool _organDonor, uint _birthYear, uint _birthMonth, uint _birthDay) public {
